...
/*   Updated: 2023/10/24 16:42:53 by meskelin         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void test_invalid_grade_update()
{
...
static void test_valid_grade_update()
{
	std::cout << "------------VALID--------------------------" << std::endl;
	try
	{
...
int main(void)
{
	test_invalid_init();
	test_valid_init();
	test_invalid_grade_update();
	test_valid_grade_update();
